package deadlock.sample.withlock;

import deadlock.sample.OverdrawnException;
...
public class TrylockDemo {
  ...
  class BadTransferOperation extends Thread {
    ...
    public void run() {
      ...
      System.out.println("Thread Complete: " + threadNum + " Successfully made " + transactionCount + " out of " + NUM_ITERATIONS);
    }
